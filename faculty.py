...
class Ui_MainWindow(object):
    ...
    def InsertData(self):
        ...
        namefac = self.lineEdit_2.text()
        cursor = con.cursor()
        cursor.execute("INSERT INTO faculty(faculty_name)"
                            "VALUES('%s')" % (''.join(namefac),
                                                  ))
        con.commit()
        #self.close()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_2.setPlaceholderText(_translate("MainWindow", "Название факультета"))
